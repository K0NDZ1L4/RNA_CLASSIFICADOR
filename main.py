...
Classificador = MLPClassifier(hidden_layer_sizes = (10,10,4), alpha=1, max_iter=1000000)
...
ClassificadorPCA = MLPClassifier(hidden_layer_sizes = (10,10,4), alpha=1, max_iter=10000)
